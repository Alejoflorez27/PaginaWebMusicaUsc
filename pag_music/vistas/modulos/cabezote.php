<header class="main-header">
	...
	<a href="inicio" class="logo">
		...
		<span class="logo-mini">
			...
			<img src="vistas/img/plantilla/sci_high.jpeg" class="img-responsive" style="padding:10px">
		...
		<span class="logo-lg">
			...
			<img src="vistas/img/plantilla/sci_highline.jpeg" class="img-responsive" style="padding:10px 0px">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              ...
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <?php echo '<img src="'.$_SESSION["foto"].'" class="user-image" alt="User Image">'; ?>
                <!-- hidden-xs hides the username on small devices so only the image appears. -->
				<!--se crea una variable de acceso para el nombre del cabezote-->
              ...
              <ul class="dropdown-menu">
                ...
                <?php
                    ...
                    //En caso de que el usuario tenga foto en la BD se pondra en el cabezote sino pondra la de por defecto
                    if ($_SESSION["foto"] != "" ) {
